...
export default function Home() {
  ...
  */
  ...
  React.useEffect(() => {
    ...
    */
    fetch("http://localhost:5000/api/github", requestOptions)
      .then((res) => res.json())
      .then(
          ...
          <div>
            ...
            {flag && (
              <div>
                ...
                <div>
                  ...
                  <img
                    src={
                      githubRepoData?.pullReqImageUrls?.all_issues_data_image
                    }
            ...
            {flag && (
              <div>
                ...
                <div>
                  ...
                  <img
                    src={
                      githubRepoData?.fb_closedAtImageUrls
                        ?.fbprophet_forecast_url
                    }
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of Commits using Facebook/Prophet based
                  on past months
                </Typography>

                <div>
                  <Typography component="h4">Forecast of Commits</Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                      githubRepoData?.fb_commitsImageUrls
                        ?.fbprophet_forecast_url
                    }
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of Closed Issues using StatsModel based
                  on past months
                </Typography>
                ...
                <div>
                  ...
                  <img
                    src={
                      githubRepoData?.stat_closedAtImageUrls
                        ?.stats_observation_url
                    }
            ...
            {flag && (
              <div>
                ...
                <div>
                  ...
                  <img
                    src={
                      githubRepoData?.stat_pullReqImageUrls
                        ?.stats_observation_url
                    }
